...
beforeEach(function () {
    ...
    $this->sub1 = $this->user->subscribe($plan1);
    $this->sub2 = $this->user->subscribe($plan2);
...
it('can read full features from subscriptions', function () {
    expect($this->sub1->getFeatures())->toEqual([
        ...
        ->and($this->sub2->getFeatures())->toEqual([
            ...
            'countable_and_uncountable_feature' => null
        ]);
});

it('can read full all uncountable features', function () {
...
it('can read full all countable features', function () {
